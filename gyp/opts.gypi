...
# found in the LICENSE file.
{
        ...
        'mips_dsp_sources': [
            ...
            '<(skia_src_path)/opts/SkBitmapProcState_mips_dsp.cpp',
            '<(skia_src_path)/opts/SkBitmapProcState_matrixProcs_mips_dsp.cpp',
            '<(skia_src_path)/opts/SkMorphology_opts_mips_dsp.cpp',
            '<(skia_src_path)/opts/SkBlurImage_opts_mips_dsp.cpp',
            '<(skia_src_path)/opts/SkTextureCompression_opts_none.cpp',
            '<(skia_src_path)/opts/SkUtils_opts_none.cpp',
            '<(skia_src_path)/opts/SkXfermode_opts_none.cpp',
        ],
