...
extern void SkBlitLCD16OpaqueRow_mips_msa(SkPMColor dst[],
                                          const uint16_t mask[], SkColor src,
...
namespace SK_OPTS_NS {
    ...
    static void D32_A8_Color_mips_msa(void* SK_RESTRICT dst, size_t dstRB,
                                      ...
                                      size_t maskRB, SkColor color, int width,
                                      int height) {
    ...
    static void D32_A8_Opaque_mips_msa(void* SK_RESTRICT dst, size_t dstRB,
        ...
        do {
            ...
            for (int i =0; i< (width & 3); i++) {
                unsigned aa = *mask++;
                *device = SkAlphaMulQ(pmc, (aa + 1)) +
                                SkAlphaMulQ(*device, (256 - aa));
                device += 1;
            }
