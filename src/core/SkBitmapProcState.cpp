...
extern void  S16_D16_filter_DX(const SkBitmapProcState&, const uint32_t*, int,
                               uint16_t*);
extern void  Clamp_S16_D16_filter_DX_shaderproc(const SkBitmapProcState&,
                                                int, int, uint16_t*, int);
extern void  Repeat_S16_D16_filter_DX_shaderproc(const SkBitmapProcState&,
                                                 int, int, uint16_t*, int);
extern void  SI8_opaque_D32_filter_DX(const SkBitmapProcState&, const uint32_t*,
                                      int, SkPMColor*);
extern void  SI8_opaque_D32_filter_DX_shaderproc(const SkBitmapProcState&,
                                                 int, int, uint32_t*, int);
extern void  Clamp_SI8_opaque_D32_filter_DX_shaderproc(const SkBitmapProcState&,
                                                       int, int, uint32_t*, int);
#endif
