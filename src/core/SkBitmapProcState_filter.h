...
static inline void Filter_32_opaque_mips(unsigned x, unsigned y,
    ...
    __asm__ __volatile__ (
            ...
            "sll            %[t1], %[t1], 8         \n\t"
            "or             %[dst], %[t0], %[t1]    \n\t"
            : [t0] "=r" (t0), [t1] "=r" (t1), [t2] "=r" (t2), [t3] "=r" (t3), [t4] "=r" (t4), [dst] "=r" (*dstColor),
            [t5] "=r" (t5), [t6] "=r" (t6), [t8] "=r" (t8), [t9] "=r" (t9), [t10] "=r" (t10)
            : [x] "r" (x), [y] "r" (y), [a00] "r" (a00), [a01] "r" (a01), [a10] "r" (a10),
            [a11] "r" (a11)
            : "hi", "lo", "memory"
            );
}
...
static inline void Filter_32_alpha_mips(unsigned x, unsigned y,
    ...
    __asm__ __volatile__ (
            ...
            "sll              %[t1], %[t1], 8         \n\t"
            "or               %[dst], %[t0], %[t1]     \n\t"
            : [dst] "=r" (*dstColor), [t0] "=r" (t0), [t1] "=r" (t1), [t2] "=r" (t2), [t3] "=r" (t3), [t4] "=r" (t4),
            [t5] "=r" (t5), [t6] "=r" (t6), [t8] "=r" (t8), [t9] "=r" (t9), [t10] "=r" (t10)
            : [x] "r" (x), [y] "r" (y), [a00] "r" (a00), [a01] "r" (a01), [a10] "r" (a10),
            [a11] "r" (a11), [alpha] "r" (alphaScale)
            : "hi", "lo", "memory"
            );
}
